...
/**
 * This prepares the GUI needed by Snos_ReportModel object 
 * display clients  personal and SMS details-retrieved 
 * from local database- in a tabular form 
 * @author Charles;
 * @see Snos_ReportModel.java, Snos_Report.java
 * @version 1.0
 *
 */
   ...
   public class Snos_TypeReport extends JInternalFrame{
        
   private boolean firsttime = true;
   private Container c;
   private JScrollPane jspane;
   private Snos_ReportModel qtbl;
   private JTable jtbl;
  ...
  // private String dept;
   //private String sec;
    ...
    public Snos_TypeReport (String data) {
        this.datapara= data; 
         initComponents ();
    }
  private void initComponents () {
	...
	if ( firsttime ) {
	  ...
	  qtbl = new Snos_ReportModel(datapara);
         qtbl.setVector();
        //qtbl.setChange();
 	 jtbl = new JTable( qtbl );
         ...
         //jtbl.setGridColor(Color.red);
         // jtbl.setRowSorter(jtbl.getRowSorter());
...
//           colorPara="read";
  ...
  public void MySorter(){
   rowsort =  jtbl.getSelectedRows();
     // TableRowSorter<rowsort> sot = new  TableRowSorter<row>();
