 ...
 * @author Charles;
 * @see DateReport.java,Action_show.java.java,GeneReportTable.java
 * @version 1.0 
 */
    public class Date_Report  extends JInternalFrame{
        
   private boolean firsttime = true;
   private Container c;
   private JScrollPane jspane;
   private Date_ReportModel qtbl;
   private JTable jtbl;
  ...
  // private String dept;
   //private String sec;
    ...
    public Date_Report  (String data) {
        this.datapara= data; 
         initComponents ();
    }
  private void initComponents () {
	...
	if ( firsttime ) {
	  ...
	  qtbl = new Date_ReportModel(datapara);
         qtbl.setVector();
        //qtbl.setChange();
