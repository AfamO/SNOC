...
public class setup_change extends JFrame{
   ...
   // private   UserInforGet home_bg;
    //private String noc,city;
    
    public setup_change(String title,String ci) {
        
        initComponents();
         setIconImage(new ImageIcon(getClass().getResource("see.jpg")).getImage()); 
         //this.noc=title;
         //this.city=ci;
         snocTF.setText(title);
         cityTF.setText(ci);
    }
     ...
     public void set_update_infor()
    {
      ...
      try{
          if(f1==null){
             ...
             JOptionPane.showMessageDialog(null, "Please Logo Information is not selected\n Click on upload logo, to get your logo setup \nfor further Information contact teledom Administrator");
             
          }else{
            dat.Update_setup_Inform(noc_name,loco, f1);  
             // JOptionPane.showMessageDialog(null, "Please Setup Information ");
          }
